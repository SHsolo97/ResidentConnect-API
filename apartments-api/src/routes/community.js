...
router.get('/api/community/health-status',community_controller.gethealthStatus); //documented
router.get('/api/community/validatetoken/:token',community_controller.valitateToken); //documented
router.put('/api/community/:id',community_controller.editCommunityDetails); //documented

router.get('/api/community',community_controller.community_list); //documented
router.get('/api/community/:id',community_controller.getCommunityById); //documented

router.post('/api/community/create',
[check('name').not().isEmpty(),
check('builder').not().isEmpty()],
community_controller.createCommunity); //documented
